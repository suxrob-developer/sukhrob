...
const Contact = () => {
  return (
    <div id='contact' >
        <div className='font-bold flex gap-2 text-[35px] md:text-[50px] my-10 mt-5 md:my-16 justify-center'> <Translate dictionary={{ru:'Свяжитесь со Mной',en:'Contact Me'}}/></div>
