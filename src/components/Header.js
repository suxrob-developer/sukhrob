  ...
  return (
    <div className='pt-[200px] lg:pt-0 flex lg:flex-row flex-col items-center bg-[#EDF2F8]  lg:h-[100vh] justify-center gap-20 '>
       ...
       <div className='flex flex-col gap-6 md:gap-10 items-center md:items-end w-full max-w-[400px]'> 
           <div className='flex justify-center items-center bg-[white] gap-10 w-full max-w-[350px] p-3 text-center rounded-[10px] shadow-lg'>
           ...
           <div className='bg-[white] w-full max-w-[300px] p-3  rounded-[15px]  text-slate-400 text-[20px] shadow-lg'>FRONTEND/REACT DEVELOPER
           </div>

          <  button type="button" class="text-white bg-[#313bac] from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2 text-center me-2 mb-2">Downlaod CV</button>
       </div>
         {/* gif for developer */}
